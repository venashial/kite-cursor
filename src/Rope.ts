...
export class Rope {
    ...
    constructor(length: number, resolution: number, mass: number, damping: number, solverIterations = 500) {
...
class RopePoint {
    ...
    static integrate(point: RopePoint, gravity: Pos, dt: number, previousFrameDt: number) {
